...
<head>
    ...
    <!-- css -->
    <link rel="stylesheet" href="<c:url value='/template/web/css/author.css'/>">
    <!-- bootstrap -->
...
<body>
    ...
    <div class="container ">
        <div class="package">
            ...
            <div class="infor">
                <img src="img/img-author.jpg" alt="" class="avatar">
                <ul class="infor1">
                    <li>Họ Và Tên: <span>Nguyễn Nhật Ánh</span></li>
                    <li>Thông tin: <span>háhajskajskajskajs</span></li>
                </ul>
            </div>
        </div>
    </div>
