    ...
    <body>
        ...
        <div class="container ">
            ...
            <div class="product">
                <div class="list-book">
                    <div class="row">
                        <c:forEach var="item" items="${model.listResults}" begin="0" end="4" step="1">
                            <div class="book1">
                                <a href="<c:url value="/read-book?action=read&id=${item.id}"/>" class="thumbail" name="id">
                                    <img src="${item.thumbnail}" alt="">
                                </a>
                                <div class="deep">
                                    <a href="<c:url value="/read-book?action=read&id=${item.id}"/>" class="book-icon">
                                        <img src="<c:url value='/template/web/img/book-icon.png'/>" alt="">
                                    </a>
                                    <a href="<c:url value="/detail-book?action=detail&id=${item.id}"/>" class="infor">Chi Tiết</a>
                                </div>
                                <div class="caption">
            ...
            <div class="product">
                <div class="list-book">
                    <div class="row">
                        <c:forEach var="item" items="${model.listResults}" begin="5" end="9" step="1">
                            <div class="book1">
                                <a href="<c:url value="/read-book?action=read&id=${item.id}"/>" class="thumbail" name="id">
                                    <img src="${item.thumbnail}" alt="">
                                </a>
            ...
            <div class="product">
                <div class="list-book">
                    <div class="row">
                         <c:forEach var="item" items="${model.listResults}" begin="10" end="14" step="1">
                            <div class="book1">
                                <a href="<c:url value="/read-book?action=read&id=${item.id}"/>" class="thumbail" name="id">
                                    <img src="${item.thumbnail}" alt="">
                                </a>
